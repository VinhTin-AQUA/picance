...
import 'package:picance/config/themes/t_container.dart';
import 'package:picance/modules/image_upscaler/models/scaler.dart';
import 'package:picance/modules/image_upscaler/models/iloveimgscaler.dart';
...
class ILoveImg extends StatefulWidget {
  final ImageScalerController builder;
  final ImageScaleType type;

  const ILoveImg({super.key, required this.builder, required this.type});

  @override
  State<ILoveImg> createState() => _ILoveImgState();
}

class _ILoveImgState extends State<ILoveImg> {
  @override
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        value:
                            widget.builder
                                .getScale<IloveimgScalerController>(widget.type)
                                .scale,
